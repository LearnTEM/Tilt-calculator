...
with ui.row():
    ui.input("h").bind_value_to(data, "h1")
    ui.input("k").bind_value_to(data, "k1")
    ui.input("l").bind_value_to(data, "l1")
...
with ui.row():
    ui.input("α").bind_value_to(data, "alpha1")
    ui.input("β").bind_value_to(data, "beta1")
...
with ui.row():
    ui.input("h").bind_value_to(data, "h2")
    ui.input("k").bind_value_to(data, "k2")
    ui.input("l").bind_value_to(data, "l2")
